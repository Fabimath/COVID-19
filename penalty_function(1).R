...
pen_fun = function(theta, ck, length_t, seq_t, B_seq_t, min_t, max_t)
{
  ...
  B_x_2_seq_t = as.matrix(B_seq_t[[3]]) # Agregado

    div = 1:3*M
    ck1=ck[1:div[1]]
    ck2=ck[(div[1]+1):div[2]]
    ck3=ck[(div[2]+1):div[3]]           #Agregado
    
   B_x_0_seq_t_times_ck1 = B_x_0_seq_t %*% ck1
   B_x_1_seq_t_times_ck1 = B_x_1_seq_t %*% ck1
   B_x_2_seq_t_times_ck1 = B_x_2_seq_t %*% ck1
    
   B_x_0_seq_t_times_ck2 = B_x_0_seq_t %*% ck2
   B_x_1_seq_t_times_ck2 = B_x_1_seq_t %*% ck2
   B_x_2_seq_t_times_ck2 = B_x_2_seq_t %*% ck2
    
   B_x_0_seq_t_times_ck3 = B_x_0_seq_t %*% ck3
   B_x_1_seq_t_times_ck3 = B_x_1_seq_t %*% ck3
   B_x_2_seq_t_times_ck3 = B_x_2_seq_t %*% ck3
